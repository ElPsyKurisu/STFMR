...
if len(sys.argv) == 1: directories = ["tmp21\\dev21"]
...
correct_troughs = correct_troughs_back[::-1]
correct_peaks = correct_peaks_back[::-1]
print(correct_troughs)
print(correct_peaks)
...
for mm in range(number_of_files):
    ...
    range_around_trough_vmixindex = np.arange(troughvmixindex-10, troughvmixindex+10)
